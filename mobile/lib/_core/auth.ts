  ...
  try {
    if (Platform.OS === "web") {
      if (typeof window !== "undefined" && window.localStorage) {
        ...
        console.log(
          "[Auth] Session token retrieved from localStorage (web):",
  ...
  try {
    if (Platform.OS === "web") {
      if (typeof window !== "undefined" && window.localStorage) {
        ...
        console.log("[Auth] Session token stored in localStorage (web) successfully");
      }
      return;
    }
  ...
  try {
    if (Platform.OS === "web") {
      if (typeof window !== "undefined" && window.localStorage) {
        ...
        console.log("[Auth] Session token removed from localStorage (web) successfully");
      }
      return;
    }
