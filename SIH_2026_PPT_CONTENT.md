# 🎯 Smart India Hackathon (SIH 2026) — Official Presentation Deck
...
## 📽️ SLIDE 1 — Title Page & Problem Context
...
### 🎙️ Member 1 (Team Leader & National Architect) Speaking Script (0:00 – 0:40)
...
- **The AEGIS Solution**:
  ...
  4. **Cyber-Physical Zero-Internet Masts**: ₹3,775 solar-powered LoRa beacon nodes with 120dB acoustic horns and optical strobes.
...
### 🎙️ Member 2 (National Telemetry & Pre-Judgment Lead) Speaking Script (0:40 – 1:15)
...
### 🎙️ Member 3 (Citizen Accessibility & Vernacular PWA Lead) Speaking Script (1:15 – 1:55)
...
- **Economic Viability & Unit Cost**:
  - **₹3,775 (~$45 USD)** per autonomous warning mast (10x cheaper than legacy imported civil defense sirens).
  - Zero ongoing cellular SIM subscription cost (operates on free 865–867 MHz license-exempt ISM band).
- **Scalability**:
...
### 🎨 Visual Layout
- Cost comparison bar chart (Legacy Municipal Siren ₹1,50,000 vs AEGIS Mast ₹3,775) + Blackout battery discharge curve (75 Days Standby / 24+ Days Disaster Cycle).

### 🎙️ Member 4 (Tri-Services Military & NDRF Operations Lead) Speaking Script (1:55 – 2:30)
...
> *Commanders can authorize **Indian Air Force Mi-17 or Chinook sorties**, dispatch **NDRF inflatable zodiacs**, and deploy **Army Engineering Regiments** to erect emergency Bailey Bridges—tracking live rescue statuses nationwide."*

---

## 📽️ SLIDE 5 — Humanitarian, Social & Measurable Impact
...
### 🎙️ Member 5 (National Logistics & Union Impact Lead) Speaking Script (2:30 – 3:15)
...
> *Most importantly: **AEGIS ALERT costs ₹0 in proprietary user hardware.** It runs on existing smartphones, tablets, and district control room laptops, while our off-grid village masts cost just ₹3,775. The Union Government of India can deploy this across all 28 states and 8 UTs tomorrow. AEGIS turns technology into an impenetrable national shield for every Indian citizen. Thank you!"*

---

## 📽️ SLIDE 6 — Research Citations & Jury Defense

### Slide Content (Bullet Points for Slide)
- **Scientific Literature**:
  1. *Guzzetti, F., et al. (2008)* — Rainfall thresholds for the initiation of landslides (*Meteorol. Atmos. Phys.*).
  2. *Steadman, R. G. (1979)* — Assessment of Sultriness & Heat Stress (*J. Appl. Meteorol.*).
  3. *Huffman, G. J., et al. (2020)* — NASA IMERG Satellite Precipitation Measurement (*NASA GSFC*).
